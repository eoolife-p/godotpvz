...
const zombie_power = {
	...
	CharacterRegistry.ZombieType.Z026BlackFootball: CharacterRegistry.ZombieType.Z008Football * 2,
	CharacterRegistry.ZombieType.Z027AngerNorm: 3,
	CharacterRegistry.ZombieType.Z029BlueFootball: 8,
}
...
const zombie_weights_ori = {
	...
	CharacterRegistry.ZombieType.Z026BlackFootball: 1000,
	CharacterRegistry.ZombieType.Z027AngerNorm: 2050,
	CharacterRegistry.ZombieType.Z029BlueFootball: 1100,
