...
const ZombieInfo = {
	...
	ZombieType.Z026BlackFootball:{
		ZombieInfoAttribute.ZombieName: "BlackZombieFootball",
		ZombieInfoAttribute.CoolTime: 0.0,
		ZombieInfoAttribute.SunCost: 325,
		ZombieInfoAttribute.ZombieScenes: preload("res://scenes/character/zombie/zombie_026_blackfootball.tscn"),
		ZombieInfoAttribute.ZombieRowType:CharacterRegistry.ZombieRowType.Land
	},
	ZombieType.Z027AngerNorm:{
		ZombieInfoAttribute.ZombieName: "ZombieAngerNorm",
		ZombieInfoAttribute.CoolTime: 0.0,
		ZombieInfoAttribute.SunCost: 75,
		ZombieInfoAttribute.ZombieScenes:preload("res://scenes/character/zombie/zombie_027_anger_norm.tscn"),
		ZombieInfoAttribute.ZombieRowType:CharacterRegistry.ZombieRowType.Both	
	},
	ZombieType.Z028ConeDancer:{
		ZombieInfoAttribute.ZombieName: "ZombieConeDancer",
		ZombieInfoAttribute.CoolTime: 0.0,
		ZombieInfoAttribute.SunCost: 75,
		ZombieInfoAttribute.ZombieScenes:preload("res://scenes/character/zombie/zombie_028_dancer_cone.tscn"),
		ZombieInfoAttribute.ZombieRowType:CharacterRegistry.ZombieRowType.Land		
	},
	ZombieType.Z029BlueFootball:{
		ZombieInfoAttribute.ZombieName: "BlueZombieFootball",
		ZombieInfoAttribute.CoolTime: 0.0,
		ZombieInfoAttribute.SunCost: 200,
